...
var UdpPort = []int{20, 21, 53, 67, 68, 69, 123, 137, 139, 161, 162, 500, 514, 520, 631, 1194, 1701, 1718, 1719, 1720, 1723, 1812, 1813, 1863, 1900, 4500, 2049}
...
func UdpInfo(ip string, port int) (*Result, error) {
	...
	if err != nil {
		// slog.Println(slog.DEBUG, "udpInfo=====", ip, "----", port, err)
	}
